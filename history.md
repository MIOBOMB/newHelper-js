...
оффициально можно перезаписывать функции фреймворка, но я не рекомендую промышлять таким так как это не совсем безопасно и в будущем может повлечь проблемы с совместимостью кода
